...
public abstract class CacheLoader<K, V> {
   ...
   */
  public abstract V load(K key) throws Exception, Pausable;
  ...
  public ListenableFuture<V> reload(K key, V oldValue) throws Exception , Pausable{
    checkNotNull(key);
  ...
  public static <K, V> CacheLoader<K, V> asyncReloading(
    ...
    return new CacheLoader<K, V>() {
      @Override
      public V load(K key) throws Exception , Pausable{
  ...
  private static final class SupplierToCacheLoader<V> extends CacheLoader<Object, V>
    ...
    @Override
    public V load(Object key)throws Pausable {
      checkNotNull(key);
