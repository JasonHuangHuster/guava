...
import com.google.common.kilimCache.CacheBuilder.NullListener;
import com.google.common.kilimCache.CacheBuilder.OneWeigher;
...
import static com.google.common.kilimCache.CacheBuilder.NULL_TICKER;
import static com.google.common.kilimCache.CacheBuilder.UNSET_INT;
...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
  ...
  static final class LoadingSerializationProxy<K, V> extends ManualSerializationProxy<K, V>
    ...
    @Override
    public V get(K key) throws ExecutionException , Pausable{
      return autoDelegate.get(key);
    }

    @Override
    public V getUnchecked(K key) throws Pausable{
      return autoDelegate.getUnchecked(key);
    }

    @Override
    public ImmutableMap<K, V> getAll(Iterable<? extends K> keys) throws ExecutionException ,Pausable{
    ...
    @Override
    public void refresh(K key)throws Pausable {
