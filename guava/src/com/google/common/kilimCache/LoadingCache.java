...
public interface LoadingCache<K, V> extends Cache<K, V>, Function<K, V> {
   ...
   */
  V get(K key) throws ExecutionException,Pausable;
   ...
   * @throws ExecutionError if an error was thrown while loading the value
   */
  V getUnchecked(K key)throws Pausable;
   ...
   * @since 11.0
   */
  ImmutableMap<K, V> getAll(Iterable<? extends K> keys) throws ExecutionException, Pausable;
...
//  V apply(K key) throws Pausable;
   ...
   * @since 11.0
   */
  void refresh(K key)throws Pausable;
